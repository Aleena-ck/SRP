    ...
    <div className="max-w-6xl mx-auto mt-12 p-8 bg-[#fff8f8] rounded-lg shadow-md">
      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        ...
        <div>
          ...
          <input type="number" placeholder="Enter Age" className="w-full p-3 rounded-md bg-[#fbeeee]" />
        </div>
      ...
      {/* College Details */}
      <h3 className="text-xl font-bold mb-4 underline">College Details</h3>
      ...
      {/* Submit Button */}
      <button className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 rounded-md transition">
        Register
      </button>
      ...
      <p className="mt-6 text-red-600 text-center text-sm font-semibold italic">
        **No result found** <br />
        <span className="text-xs normal-case not-italic">Please check if you have entered your details properly</span>
      </p>
    </div>
  );
};
