...
const Home = () => {
  ...
  //mock of emergency requests
const [emergencyRequests, setEmergencyRequests] = useState([
  {
    patient: "Arjun Menon",
    bloodGroup: "O+",
    hospital: "City Hospital, Kollam",
    ...
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <section className="flex flex-col items-center px-6 py-12 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <Link to="/register"><button className="text-lg font-semibold px-8 py-4 rounded-lg bg-red-600 text-white hover:bg-red-700 transition">
            Donate Now
          </button></Link>
        </div>
      </section>
